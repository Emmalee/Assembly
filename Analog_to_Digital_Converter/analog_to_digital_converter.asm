...
ReadNumber1:
    mov x+0, R7                ; Reads SW0-7, sets x-low to R7
    mov x+1, #0                ; Sets x-high to 0
    ret

ReadNumber2:
    mov x+0, R6                   ; Reads SW0-7, sets x-low
    mov x+1, #0                   ; Sets x-high
    ret
...
N8:     mov LEDRA, P3      ;display binary value of voltage #1 on the LEDs
        mov R7, P3         ;save the binary value of voltage #1 in r7
        ret
...
L8:     mov LEDG, P3       ;display binary voltage #2 value on the green LEDs
        mov R6, P3         ;save the binary voltage #2 value in r6
        ret
...
myprogram: 
         ...
         mov LEDRA, #0 ; Turn off all of the LEDs 
         mov LEDRB, #0 
         mov LEDRC, #0 
         mov LEDG, #0 
         ...
         setb LCD_ON
    clr LCD_EN                    ;Default state of LCD enable must be zero
    lcall Wait40us
